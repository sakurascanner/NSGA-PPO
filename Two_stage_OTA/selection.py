...
def generate_reference_points(num_objs, num_divisions_per_obj=3):
        ...
        for ind in population:
            if not ind.fitness.valid:
                try:
                    ...
                    evaluated_value = (float('inf'), -float('inf'), -float('inf'), -float('inf'), float('inf'), float('inf'), float('inf'), float('inf'), float('inf'), float('inf'), float('inf'), -10.0)
